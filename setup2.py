"""
Much of the build system code was adapted from work done by the statsmodels
developers [1], which was in turn based on work done in pandas [2], which was
in turn based on work done in pyzmq [2] and lxml [3].
[j] http://github.com/statsmodels/statsmodels/
[2] http://pandas.pydata.org
[3] http://zeromq.github.io/pyzmq/
[4] http://lxml.de/
"""
...
README = open(pjoin(curdir, "README.md")).read()

DISTNAME = 'statsmodels'
DESCRIPTION = 'Statistical computations and models for use with SciPy'
LONG_DESCRIPTION = README
MAINTAINER = 'John Evans, Joe Lee'
MAINTAINER_EMAIL ='john.g.evans.ne@gmail.com'
URL = 'http://github.com/quintusdias/pyhdfeos'
LICENSE = 'BSD License'
DOWNLOAD_URL = ''
